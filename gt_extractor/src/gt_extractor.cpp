...
int main(int argc, char **argv){
	...
	if (!read_gt_data(ros::package::getPath("robot_localization_data") + "/logs/scenario1/gt.txt", gt)) {
    ...
    imwrite(ros::package::getPath("robot_localization_data") + "/logs/scenario1/gt.png", blank_gt_img);
    imwrite(ros::package::getPath("robot_localization_data") + "/logs/scenario1/pf.png", blank_pf_img);
    imwrite(ros::package::getPath("robot_localization_data") + "/logs/scenario1/ideal.png", blank_ideal_img);
    imwrite(ros::package::getPath("robot_localization_data") + "/logs/scenario1/center.png", blank_center_img);
    imwrite(ros::package::getPath("robot_localization_data") + "/logs/scenario1/sum.png", blank_pf_img);
